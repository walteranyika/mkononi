    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.loans.update", [$loan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_amount_to_repay') ? 'is-invalid' : '' }}" type="number" name="total_amount_to_repay" id="total_amount_to_repay" value="{{ old('total_amount_to_repay', $loan->total_amount_to_repay) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interest') ? 'is-invalid' : '' }}" type="number" name="interest" id="interest" value="{{ old('interest', $loan->interest) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_repayment_amount') ? 'is-invalid' : '' }}" type="number" name="monthly_repayment_amount" id="monthly_repayment_amount" value="{{ old('monthly_repayment_amount', $loan->monthly_repayment_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admin_fee') ? 'is-invalid' : '' }}" type="number" name="admin_fee" id="admin_fee" value="{{ old('admin_fee', $loan->admin_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_interest') ? 'is-invalid' : '' }}" type="number" name="monthly_interest" id="monthly_interest" value="{{ old('monthly_interest', $loan->monthly_interest) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admin_fee_percentage') ? 'is-invalid' : '' }}" type="number" name="admin_fee_percentage" id="admin_fee_percentage" value="{{ old('admin_fee_percentage', $loan->admin_fee_percentage) }}" step="0.01">
