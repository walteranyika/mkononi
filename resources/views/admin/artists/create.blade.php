    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.artists.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('six_month_royalties') ? 'is-invalid' : '' }}" type="number" name="six_month_royalties" id="six_month_royalties" value="{{ old('six_month_royalties', '') }}" step="0.01" required>
